...
employees = User.create!([
	{name: 'Erich Seifert', position: 'CEO', password: password, password_confirmation: password, email: 'erichseifert@joust.io', image: File.open('app/assets/images/eSeifert.jpg', twitter: "erichseifert", linkedin: "http://www.linkedin.com/pub/erich-seifert/22/433/ab"), role: "admin"}, 
	{name: 'Mike Lilly', position: 'CTO', password: password, password_confirmation: password, email: 'mikelilly@joust.io', image: File.open('app/assets/images/mLilly.jpg'), twitter: "wackyanimation", linkedin: "http://www.linkedin.com/pub/mike-lilly/34/522/302", role: "admin"}, 
	{name: 'Jeffrey Glusman', position: 'COO', password: password, password_confirmation: password, email: 'jeffreyglusman@joust.io', image: File.open('app/assets/images/jGlusman.jpg'), twitter: "theglus", linkedin: "http://www.linkedin.com/pub/jeffrey-glusman/33/46a/4a2", role: "admin"}, 
